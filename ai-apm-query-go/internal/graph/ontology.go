...
var entityTypes = map[string]struct{}{
	...
	"replicaset": {}, "statefulset": {}, "daemonset": {}, "job": {}, "cronjob": {}, "pod": {}, "container": {},
	"k8s_service": {}, "ingress": {}, "endpoint_slice": {}, "pvc": {}, "pv": {}, "storage_class": {}, "nad": {}, "network": {}, "data_volume": {}, "disk_device": {}, "volume": {}, "virtual_interface": {}, "cni": {},
	"vm": {}, "vmi": {}, "migration": {},
...
var relations = map[string]map[string]struct{}{
	...
	"USES_CNI":            {"nad": {}, "cni": {}},
	"CONNECTS_TO_NETWORK": {"virtual_interface": {}, "network": {}},
...
var relationPairs = map[string]map[string]map[string]struct{}{
	...
	"HOSTS":               {"physical_server": {"k8s_node": {}}},
	"CONTAINS":            {"k8s_cluster": {"namespace": {}, "k8s_node": {}}},
	"OWNS":                {"deployment": {"replicaset": {}}, "replicaset": {"pod": {}}, "statefulset": {"pod": {}}, "daemonset": {"pod": {}}, "job": {"pod": {}}, "cronjob": {"job": {}}},
	"INSTANCE_OF":         {"vmi": {"vm": {}}},
