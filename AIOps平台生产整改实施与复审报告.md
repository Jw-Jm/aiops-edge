...
| Python 全量 | `AIOPS_DATA_DIR=<临时目录> ai-orchestrator/.venv314/bin/python -m pytest -q` | **1204 passed, 1 skipped, 2 warnings**；首轮系统 Python 3.9/沙箱权限错误已按约束改用项目 Python 3.14 和授权回环端口后重试。 |
