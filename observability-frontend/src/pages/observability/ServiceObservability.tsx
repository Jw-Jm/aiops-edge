...
import ServiceMapView from './service/ServiceMapView'
import ServiceDependencyView from './service/ServiceDependencyView'
import ServiceMatrixView from './service/ServiceMatrixView'
...
const ServiceObservability: React.FC = () => {
  ...
  return <div className="page">
    ...
    <section aria-label="专家关系探索" style={{ marginTop: 16 }}><ServiceExploreView graph={fallbackGraph} impactGraph={impactGraph} onRefresh={() => setStructureRefresh((value) => value + 1)} /></section>
  </div>
}
