        ...
        {secondary.map((issue) => {
          ...
          return <div key={issue.id} className="priority-issue-list__item">
            <div style={{ minWidth: 0, flex: 1 }}>
              ...
              <div className="priority-issue-list__meta">影响 {issue.affectedServices} 个资源 · 持续 {issue.durationMinutes > 0 ? `${issue.durationMinutes} 分钟` : '未提供'}{issue.startedAt ? ` · ${issue.startedAt}` : ''}</div>
            </div>
