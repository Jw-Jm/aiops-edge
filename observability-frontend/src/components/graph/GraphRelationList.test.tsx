...
describe('GraphRelationList', () => {
  it('supports keyboard focus and stable relation ordering', () => {
    ...
    render(<GraphRelationList rows={[{ id: 'e-1', source: 'a', target: 'b', sourceUid: 'a', targetUid: 'b', relationType: 'DEPENDS_ON', sourceName: '服务 A', targetName: '节点 B', label: '依赖', style: 'structural', propagatesFailure: false }]} onLocate={onLocate} />)
